...
Oliotyylisen ja funktionaalisen ohjelmointityylin, deklaratiivisen ja imperatiivisen paradigman sekä myös Java ja JavaScript kielten eroja on pyritty havainnollistamaan [Oliolaskurin](src/examples/Oliolaskuri.java) ja [Funktionaalisen laskurin](src/examples/FunktionaalinenLaskuri.js) vertailussa.
