...
Syksyllä 2022 on pakollisena palautettavana **vain Teamsissä oleva Kafka-tehtävä**. Palauta tiedostomuodossa oleelliset koodit ja asetukset sekä tuloste screenshotteja!
[Kafka-tehtävä - Syksy 2022](./docker-test/README.md)
...
## Luennot Syksy 2022
Juhanin [intro aiheeseen Software Architectures](SoftwareArchitecturesAndPatterns.pdf) ja [lyhyt kafka-katsaus](ApacheKafka_DistributedEventStreamOrBroker.pdf). 

## Luentovideot aiemmilta kerroilta
Itse katsottavaksi Ohton luentovideoita. Huomaa, että jos videoissa puhutaan tehtävistä, ne koskevat vanhoja tehtäviä, joita ei tehdä:
...
Juhanin [yritys selittää muutama käytetty termi ohjelmoijan arkikielellä. Onnistuiko?](./MuutamiaArkkitehtuuriLuennonTermeja_YrityksiaSelkokielisiksiSelityksiksi.pdf)
...
### Itsenäinen kertaustehtävä (Ei palauteta, käytä luetun kertaamiseen): 
